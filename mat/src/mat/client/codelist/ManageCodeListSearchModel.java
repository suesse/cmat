...
public class ManageCodeListSearchModel implements SearchResults<CodeListSearchDTO>,
	...
	//US190, US192
	private static String[] headers = new String[] { "Name","Last Modified","Steward","Category","Code System", "History","Clone","Export"};
	private static boolean[] sortable = new boolean[]{true,false,true, true, true, false,false,false}; //US 385
	private static String[] widths = new String[] { "25%","15%","20%", "10%", "10%", "5%","5%","5%"};
