...
public class CountUniqueByDate {
	protected String funcName = "COUNTUNIQUEBYDATE";
	private Qdsel qdsel;
	...
	public CountUniqueByDate(Operator operator, String primitiveTerm, Qdsel qdsel, String property) {
		setQdsel(qdsel);
		switch (operator) {
			case LESS_THAN:	
